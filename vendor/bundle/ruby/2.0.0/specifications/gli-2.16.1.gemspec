...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      ...
      s.add_development_dependency(%q<rainbow>, ["~> 1.1", "~> 1.1.1"])
      s.add_development_dependency(%q<clean_test>, ["~> 1.0"])
      s.add_development_dependency(%q<cucumber>, ["~> 2.4"])
      s.add_development_dependency(%q<gherkin>, ["~> 4.0"])
      s.add_development_dependency(%q<aruba>, ["= 0.5.1"])
      s.add_development_dependency(%q<sdoc>, ["~> 0.4"])
      s.add_development_dependency(%q<faker>, ["= 1.0.0"])
    else
      s.add_dependency(%q<rake>, ["~> 0.9.2.2"])
      s.add_dependency(%q<rdoc>, ["~> 4.2"])
      s.add_dependency(%q<rainbow>, ["~> 1.1", "~> 1.1.1"])
      s.add_dependency(%q<clean_test>, ["~> 1.0"])
      s.add_dependency(%q<cucumber>, ["~> 2.4"])
      s.add_dependency(%q<gherkin>, ["~> 4.0"])
      s.add_dependency(%q<aruba>, ["= 0.5.1"])
      s.add_dependency(%q<sdoc>, ["~> 0.4"])
